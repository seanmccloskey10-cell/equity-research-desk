...
- *"Replace NVDA with MSFT in my watchlist."*
- *"Reset my watchlist to just NVDA."*
...
- *"The price for NVDA looks wrong — investigate."*
...
> *"Make my AI Brief more personal. At the top of `config/briefing_prompt.md`, have it open by addressing me by name, and in the 'Watchlist snapshot' section have it lead with my own watchlist before the broader market context (currently the other way round). Keep all the accuracy rules exactly as they are — just change the voice and the ordering. Show me the diff before saving."*
...
- *"Add a currency toggle so I can see prices in my local currency as well as USD."*
- *"Add Financial Modeling Prep as a data source."* (see APIS.md for the API directory)

## Learning the codebase (for when you're curious)
