...
- Prefer ticker symbols ($NVDA, $MSFT) when referring to positions so the reader can spot them fast.
...
One or two sentences max. The headline the reader should take away if they read nothing else. Example tone: "Watchlist up 1.2% vs. S&P at 0.5% — NVDA led on a 3% gain, MSFT pulled back 1.9% on macro headlines."
...
3–4 open-ended questions worth journaling on. These are reflection prompts, not recommendations. Good ones test whether the reader's thesis still holds; bad ones tell the reader what to do.
